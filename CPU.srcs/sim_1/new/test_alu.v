...
ALU ALU_inst(
  ...
  .Read_data_2(Read_data_2),
  .Sign_extend(Sign_extend),
  .Opcode(6'b000000), // example opcode value
  .Function_opcode(6'b100000), // example function opcode value
  .Shamt(5'b00000), // example shamt value
  .PC_plus_4(32'h80000004), // example PC+4 value
  .ALUOp(2'b00), // example ALUOp value
  .ALUSrc(ALUSrc),
...
initial begin
  // Test case 1
  Read_data_1 = 32'h00000002;
  Read_data_2 = 32'h00000003;
